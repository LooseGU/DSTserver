...
AddModRPCHandler("railcart", "SpeedUp", function(player)
    if not _G.TheWorld.ismastersim or player.components.railcart == nil then
		return
	end
...
AddPrefabPostInit("player_classified",function(inst)
	inst.railcart_ison=_G.net_bool(inst.GUID, "railcart_ison", "railcart_ison")
	inst.railcart_nx=_G.net_float(inst.GUID, "railcart_nx", "railcart_nx")
	inst.railcart_ny=_G.net_float(inst.GUID, "railcart_ny", "railcart_ny")
	inst.railcart_nz=_G.net_float(inst.GUID, "railcart_nz", "railcart_nz")
	inst.railcart_speed=_G.net_float(inst.GUID, "railcart_speed", "railcart_speed")
	inst.railtrack_tool=_G.net_bool(inst.GUID, "railtrack_tool", "railtrack_tool")
	inst.railtrack_tool_isocean=_G.net_bool(inst.GUID, "railtrack_tool_isocean", "railtrack_tool_isocean")
...
local containers_widgetsetup_oldfn = containers.widgetsetup  
function containers.widgetsetup(container, prefab, data, ...)
    ...
    if t ~= nil then
        ...
        containers_widgetsetup_oldfn(container, prefab, data, ...)
    end
end
...
if inventory ~= nil and inventory.maxslots ~= nil and inventory.maxslots > 15 then
    params.railtrack_tool.widget.pos=_G.Vector3(-43, -282, 0)
...
AddGlobalClassPostConstruct("widgets/inventorybar", "Inv", function()
    ...
    function Inv:LoadSpeedometer(self)
        ...
        --self.hudspeedometer:SetPosition(_G.Vector3(100,50,0))
...
GLOBAL.STRINGS.NAMES.RAILTRACK_TOOL = "Railway Track Tool"
GLOBAL.STRINGS.RECIPE_DESC.RAILTRACK_TOOL = "Tool to place railway tracks."
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_TOOL = "Can be used to place railway tracks... or to hit your the face of my enemies."

GLOBAL.STRINGS.NAMES.RAILTRACK_DEFAULT = "Railway Track"
GLOBAL.STRINGS.NAMES.RAILTRACK_DEFAULT_ITEM = "Railway Track"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_DEFAULT = "Choo Choo!"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_DEFAULT_ITEM = "Default railway track."
GLOBAL.STRINGS.RECIPE_DESC.RAILTRACK_DEFAULT_ITEM = "Default railway track."

GLOBAL.STRINGS.NAMES.RAILTRACK_OCEAN = "Floater Railway Track"
GLOBAL.STRINGS.NAMES.RAILTRACK_OCEAN_ITEM = "Floater Railway Track"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_OCEAN = "I don't trust that thing."
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_OCEAN_ITEM = "Water-placeable railway track."
GLOBAL.STRINGS.RECIPE_DESC.RAILTRACK_OCEAN_ITEM = "Water-placeable railway track."


GLOBAL.STRINGS.NAMES.RAILTRACK_BOOST = "Booster Railway Track"
GLOBAL.STRINGS.NAMES.RAILTRACK_BOOST_ITEM = "Booster Railway Track"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_BOOST = "MUCH MORE CHOO CHOO!"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_BOOST_ITEM = "Speed boosting railway track."
GLOBAL.STRINGS.RECIPE_DESC.RAILTRACK_BOOST_ITEM = "Speed boosting railway track."


GLOBAL.STRINGS.NAMES.RAILTRACK_DAMP = "Damper Railway Track"
GLOBAL.STRINGS.NAMES.RAILTRACK_DAMP_ITEM = "Damper Railway Track"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_DAMP = "At least it is better than flying of the tracks."
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_DAMP_ITEM = "Speed damping railway track."
GLOBAL.STRINGS.RECIPE_DESC.RAILTRACK_DAMP_ITEM = "Speed damping railway track."


GLOBAL.STRINGS.NAMES.RAILTRACK_REVERSE = "Reverser Railway Track"
GLOBAL.STRINGS.NAMES.RAILTRACK_REVERSE_ITEM = "Reverser Railway Track"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_REVERSE = "It makes me dizzy..."
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.RAILTRACK_REVERSE_ITEM = "Direction changer railway track."
GLOBAL.STRINGS.RECIPE_DESC.RAILTRACK_REVERSE_ITEM = "Direction changer railway track."
